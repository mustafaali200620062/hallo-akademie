...
export default function LehrerExamsPage() {
  ...
  // ✅ إنشاء الاختبار فقط (الأسئلة بتتحفظ لوحدها)
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccess('✅ تم إنشاء الاختبار! أضف الأسئلة الآن')
          ...
          <>
            <div className="mb-6 flex justify-between items-center">
              ...
              <button
                ...
                className="bg-gray-600 text-white px-6 py-2 rounded-lg font-bold hover:bg-gray-700 transition-colors"
              >
                ← العودة للاختبارات
              </button>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
              ...
              {questions.length === 0 && (
                <p className="text-gray-500 text-sm font-bold text-center py-4">
                  اضغط على أحد الأزرار أعلاه لإضافة سؤال
                </p>
              )}
            </div>
          </>
            ...
            {showForm && groups.length > 0 && (
              <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  >
                    ✅ إنشاء الاختبار ثم إضافة الأسئلة
                  </button>
                </form>
              </div>
            )}
                          ...
                          <td className="px-6 py-4">
                            <span className={`px-2 py-1 rounded-full text-xs font-bold ${
                              ...
                              {exam.status === 'active' ? '✅ نشط' :
                               exam.status === 'scheduled' ? '⏰ مجدول' : '⚪ منتهي'}
                            </span>
                          </td>
                          <td className="px-6 py-4">
                            <div className="flex items-center gap-2 flex-wrap">
                              ...
                              <button
                                ...
                                className="bg-purple-100 text-purple-700 px-3 py-1 rounded-lg font-bold hover:bg-purple-200 transition-colors text-sm"
                              >
                                ✏️ إضافة أسئلة
                              </button>
                              <button
