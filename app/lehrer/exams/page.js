...
export default function LehrerExamsPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setQuestions([])
      setFormData({
        title: '', description: '', group_id: '', level_id: '',
        starts_at_year: '', starts_at_month: '', starts_at_day: '',
        starts_at_hour: '', starts_at_minute: '', starts_at_ampm: 'AM',
        ends_at_year: '', ends_at_month: '', ends_at_day: '',
        ends_at_hour: '', ends_at_minute: '', ends_at_ampm: 'AM',
