...
export default function AssistentRequestsPage() {
    ...
    <div className="min-h-screen bg-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-2xl font-extrabold">طلبات الانضمام</h1>
            </div>
            <button 
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
                  ...
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="bg-green-600 hover:bg-green-700 text-white px-6 py-2 rounded-lg font-extrabold transition-colors disabled:opacity-50 flex items-center gap-2"
                      >
                      ...
                      <button
                        ...
                        disabled={processing === request.id}
                        className="bg-red-600 hover:bg-red-700 text-white px-6 py-2 rounded-lg font-extrabold transition-colors disabled:opacity-50 flex items-center gap-2"
                      >
        ...
        {otherRequests.length > 0 && (
          <div>
            <h2 className="text-xl font-black mb-4 text-gray-600">📜 الطلبات السابقة</h2>
                ...
                <div key={request.id} className="bg-white rounded-xl shadow p-4 hover:shadow-md transition-shadow">
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap gap-4 text-sm text-gray-500 font-bold mt-1">
        ...
        {requests.length === 0 && (
          <div className="bg-white rounded-xl shadow-lg p-12 text-center text-gray-500">
            ...
            <p className="text-lg font-extrabold">لا توجد طلبات انضمام</p>
